...
void setup_dirs()
{
    ...
    mscbl_log_dbg(config, "config.home_path=%.*s (ending: 0x%02x)", mscbl_config.home_path.size, mscbl_config.home_path.v, mscbl_config.home_path.v[mscbl_config.home_path.size]);
    mscbl_log_dbg(config, "config.atlas_dir=%.*s (ending: 0x%02x)", mscbl_config.atlas_dir.size, mscbl_config.atlas_dir.v, mscbl_config.atlas_dir.v[mscbl_config.atlas_dir.size]);
    mscbl_log_dbg(config, "config.db_path=%.*s (ending: 0x%02x)", mscbl_config.db_path.size, mscbl_config.db_path.v, mscbl_config.db_path.v[mscbl_config.db_path.size]);
}
