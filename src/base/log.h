...
#define mscbl_log_error(module, fmt, ...) printf("[" ASCII_RED #module ASCII_RESET "] " fmt "\n", __VA_ARGS__)
...
#define PERF_END(A)   printf("[PERF (" #A ")]: %.6f seconds", (float)(clock() - perf_start_##A) / CLOCKS_PER_SEC)
